...
# Configuration now comes from settings
SECRET_KEY = settings.SECRET_KEY
ALGORITHM = "HS256" # This can also be moved to settings if it needs to be configurable
ACCESS_TOKEN_EXPIRE_MINUTES = settings.ACCESS_TOKEN_EXPIRE_MINUTES

pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto")
# Ensure tokenUrl matches the actual endpoint in user_router and uses API_V1_STR
